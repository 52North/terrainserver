...
public class DEMServlet extends HttpServlet
{
    ...
    private double mMinCellSize = 50.; // todo: doku inst-hbu / Inst-HBU: "h�ngt von Quell-Grids ab!"
    private double mMinCellSizeLatLon = 4.629627e-4; // todo: doku inst-hbu / Inst-HBU: "h�ngt von Quell-Grids ab!"
            ...
            if (lRequest.equalsIgnoreCase("GetDEM") || lRequest.equalsIgnoreCase("GetScene"))
            {
                ...
                if (! lBBox.hasMetricSRS()) {
                    if (lBBox.hasGeographicSRS()) {
                        // metrisch ben�tigte Parameter umrechnen  // todo inst-hbu
                ...
                String lResFile;
                try {
                    lResFile = lHlp.setUpDEM(     // TODO arbeitet f�r lat/lon noch nicht sauber! -> QS!
                ...
                pResponse.setContentType(mime); // MIME-Typ f�r Antwort setzen
